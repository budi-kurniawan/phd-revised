...
if __name__ == '__main__':
    ...
    viper_num_learning_episodes = 100000
    cobra_num_learning_episodes = 500000
    ...
    results_name = d2dsql_policy + '-' + str(viper_num_learning_episodes) + \
        '-vs-ac-mo-random-' + str(cobra_num_learning_episodes) + '-' + mo_agent + '-basic-a'
    ...
    for trial in range(start_trial, start_trial + num_trials):
        ...
        cobra_policy_path = 'rl2020_results/ac-mo-random-001-500000-' + mo_agent + '/policy0' + str(trial) \
                + '-' + str(cobra_num_learning_episodes) + '.p'
        cobra_tester = MultiObjectiveActorCriticTester(cobra_policy_path, discretizer=discretizer, num_rewards=num_rewards, id='cobra')
#        cobra_policy_path = 'rl2020_results/ac-random-001/policy0' + str(trial) + '-' + str(cobra_num_learning_episodes) + '.p'
