...
from rl2020.tester_builder.impl.qlearning_tester_builder import QLearningTesterBuilder
...
if __name__ == '__main__':
    ...
    test_code = 'ql-random'
    results_name = test_code + '-200000-basic-a'
    out_path = 'rl2020_test_results/' + results_name
    start_trial = 0; num_trials = 10; num_episodes = 200; num_steps = 700    
    policy_parent_path = 'rl2020_results/ql-so-200K/' + test_code + '/'; num_learning_episodes = 200_000
    tester_builder = QLearningTesterBuilder(policy_parent_path, num_learning_episodes, AceZeroDiscretizer14000())
