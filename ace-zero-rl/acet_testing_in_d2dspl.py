...
if __name__ == '__main__':
    ...
    test_name = '002'
    results_name = 'ac-' + test_name + '-050000-basic-a'
    #results_name = 'baseline-blue-stern-conversion-agent-basic-c2'
    out_path = 'rl2020_test_results/d2dspl/ORG/' + results_name
    start_trial = 0; num_trials = 10; num_episodes = 200; num_steps = 700
    
    policy_parent_path = 'rl2020_results/d2dspl/ORG/d2dspl-ac-' + test_name + '/'; num_learning_episodes = 50_000
