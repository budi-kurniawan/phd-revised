...
# from revised_thesis.performance_graph_util import *
...
#     result_path = './ac-so/ac-performance-errorbars-1b.pdf'
#     data_sources = [
...
#     draw(data_sources, result_path)
    ...
    result_path = './ac-so/ac-performance-errorbars-2.pdf'
